...
export const supabaseStorage = {
  // Submit client enquiry to Supabase
  async submitEnquiry(data: QuestFormData): Promise<boolean> {
    try {
  ...
  async updateEnquiry(id: string, updates: { status?: string; admin_notes?: string }): Promise<boolean> {
    try {
